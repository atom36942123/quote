...
for quote in quote_list:
	img=convert(quote=quote,author=None,fg="white",image="asset/background.png",border_color="black",font_size=45,font_file="asset/times.ttf",width=1080,height=1080)
